 ...
 * @author Luís Felipe
 */
public class Compras_GUI extends javax.swing.JFrame {

    /**
     * Creates new form Compras_GUI
     */
    public Compras_GUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Compras_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Compras_GUI().setVisible(true);
            }
        });
    }
